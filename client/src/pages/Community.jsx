...
const Community = () => {
  ...
  return (
    <div className='p-6 pt-20 md:pt-10 xl:px-12 2xl:px-20 w-full mx-auto h-full overflow-y-scroll'>

      <h2 className='text-3xl font-semibold text-center mb-5  text-gray-800 dark:text-white'>Community Images</h2>
          ...
          <div className='flex flex-wrap max-sm:justify-center gap-5'>
            ...
            { images.map((item, index)=>(
              ...
              <a key={index} href={item.imageUrl} target='_blank' className='relative group block rounded-lg overflow-hidden border border-gray-200 dark:border-purple-700 shadow-sm hover:shadow-md transition-shadow duration-300'>
                ...
                <img src={item.imageUrl} className='w-full h-60 md:h-50 2xl:h-62 object-cover group-hover:scale-105 transition-transform duration-300 ease-in-out' alt="" />
