...
const Navbar = () => {
  ...
  const { setIsMenuOpen, isMenuOpen, isSignedIn, theme, setTheme, navigate, credits, freeCredits, isCreditsLoading } = useAppContext();
  ...
  return (
    <nav className="border-b border-gray-200 dark:border-white/30 px-4 py-2 sm:py-3 shadow-sm flex items-center">
      ...
      <div className='w-full flex gap-1.5 sm:gap-2 justify-end'>
